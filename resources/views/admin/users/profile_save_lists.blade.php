...
<div class="profile-body" style="display: inline-flex;width: 100%;">
    <div class="profile-info-left" style="display: inline-flex;flex-direction: column;border-right: 1px solid #0000002e;margin: 50px 25px 30px 120px;padding-right: 20px;">
        ...
        <span style="margin: 10px;font-size: 20px;"><a href="{{route('admin.savelists.show' , ['username'=> $user->name])}}" style="text-decoration: none;">Save lists</a></span>
    ...
    <div class="profile-right"style="margin-top: 50px;width: 70%;">
        <ul class="list-group">
            ...
            <li class="list-group-item d-flex justify-content-between align-items-center">
                <a href="{{ route('admin.savelists.show.posts' , ['username'=> $user->name , 'listname'=> $list->name])}}" style="text-decoration: none">{{$list->name}}</a>
                <span class="badge badge-primary badge-pill" style="background: #007bff;">
                    
                    {{$list->postsinsave()->get()->count()}}
