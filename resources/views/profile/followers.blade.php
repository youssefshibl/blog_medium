...
<div class="profile-body" style="display: inline-flex;width: 100%;">
    <div class="profile-info-left" style="display: inline-flex;flex-direction: column;border-right: 1px solid #0000002e;margin: 50px 25px 30px 120px;padding-right: 20px;">
        ...
        <span style="margin: 10px;font-size: 20px;"><a href="{{route('profile.followers')}}" style="text-decoration: none;">Followers</a></span>
        @endif
            ...
            <div class="all-cards" style="display: inline-flex;flex-wrap: wrap">
                ...
                <div class="only-card" style="padding: 10px 40px;background: #f6f6fa;border-radius: 5px;border: 2px solid #fd483d36;margin: 0px 10px;">
                    ...
                    <div class="box-option">
                        ...
                        @if(in_array($follow->id, auth()->user()->following->pluck('id')->toArray()))
                        ...
                        @else
                        <h5 style="text-decoration: none;color: white;background: #fd483d;padding: 5px 12px;border-radius: 4px;text-align: center;cursor: pointer;"><a href="{{route('makefollow',['user_id'=> $follow->id])}}" style="text-decoration: none;color: white">follow</a></h5>
                        @endif
                    </div>
                </div>
                @endforeach
