...
<div class="me-container" style="display: inline-flex;justify-content: space-between;width: 100%;margin: 10px;">
    <div class="me-left" style="margin-left: 20px;margin-top: 10px;width: 20%;border-right: 1px solid #0000002e;">
            <a href="{{ route('me.account' )}}" style="display: block;margin-top: 10px;margin-bottom: 10px;font-size: 18px;color: #4f4d4dc4;text-align: left;text-decoration: none"><span style=" font-weight: bold;font-size: 21px;">{{ __('messages.account')}}</span></a>
            <a href="{{ route('me.setting' )}}" style="display: block;margin-top: 10px;margin-bottom: 10px;font-size: 18px;color: #4f4d4dc4;text-align: left;text-decoration: none"><span>{{ __('messages.setting')}}</span></a>
...
<div class="information-box" style="font-size: 25px;font-weight: 700;margin-bottom: 10px;">
    ...
    <div class="information-box-main" style="width: 100%;display: inline-flex;justify-content: space-between;align-items: center;">
        <select name="lange" id="" style="background: transparent; width: 60%;height: 30px;border: none;font-size: 16px;font-weight: 200;margin-left: 20px;border-bottom: 2px solid #71716d5c" disabled="" >
            <option value="ar"
            @if(app()->getLocale() == 'ar')
                selected
            @endif
...
<div class="information-box" style="font-size: 25px;font-weight: 700;margin-bottom: 10px;">
    <div class="title">
        {{ __('messages.image profile') }} <span style="color: white;background: #00800099;padding: 2px 15px;border-radius: 16px;">125 x 125</span>
    </div>
    <div class="information-box-main" style="width: 100%;display: inline-flex;justify-content: space-between;align-items: center;margin-top: 40px;">
        ...
        <label for="avatar" style="font-size: 15px;background: #00800078;color: white;padding: 6px 17px;border-radius: 19px;">{{ __('messages.upload image')}}</label>
