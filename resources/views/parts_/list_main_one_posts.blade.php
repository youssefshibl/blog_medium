...
<div class="box-post">
        <div class="box-title">
            ...
            <span>Youssef shebl .</span>
            <span>Nov 15, 2021</span>
        </div>
        <div class="box-body">
            <div class="box-body-lef">
                <div class="title">How I Found P1 bug Due to Sensitive data exposure And Earn $$$$</div>
                <div class="body">A common interview question asked at larger companies, reversing a linked list is a problem I’ve seen trip up a lot of engineers throughout my time at Outco. Often being unable to solve this problem stems from an engineer n</div>
            </div>
        ...
        <div class="box-footer">
            ...
            <div class="box-footer-right">
                <svg width="25" height="25" viewBox="0 0 25 25" fill="none" class="oc">
                ...
                <svg class="bk od oe" width="25" height="25">
